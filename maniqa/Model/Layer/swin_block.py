...
from maniqa.Model.Layer.mlp import Mlp
from maniqa.Model.Layer.window_attention import (
    WindowAttention,
    window_partition,
    window_reverse,
)
...
class SwinBlock(nn.Module):
    r'''Swin Transformer Block（支持 W-MSA 与 SW-MSA 的移位窗口注意力）。'''
